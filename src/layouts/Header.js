...
const Header = (props) => {
  ...
  const toggleAccountMenu = () => {
    const navAccountBtnEl = document.getElementById("nav__account-btn");
    const navAccountBtnArrowEl = document.getElementById("nav__account-btn-arrow");
    const navAccountEl = document.getElementById("nav__account");
  
    const display = window.getComputedStyle(navAccountEl).display;
    if (display == "none") {
      navAccountEl.style.display = "block";
      navAccountBtnArrowEl.innerHTML = "&#x25B3;";
    } else {
      ...
      <nav className="nav">
        <div className="nav__flexbox">
          <div className="nav__item1">
            <a href="/" id="home" className="nav__logoBtn noselect">
          ...
          <div className="nav__item2">
            <a href="/" className="nav__normalBtn noselect">Mission</a>
            <a href="/" className="nav__normalBtn noselect">Launches</a>
            <a href="/" className="nav__normalBtn noselect">About us</a>
          </div>
          <div className="nav__item3">
            <a onClick={toggleAccountMenu} id="nav__account-btn" className="noselect">My Account<span id="nav__account-btn-arrow">&#x25BD;</span></a>
            <div id="nav__account">
              <div className="nav__account_profile">
                <a href="/auth/login" className="nav__login-btn">Log In</a>
              </div>
              <div className="nav__account_middle">
                <a href="/auth/login" className="nav__account-settings-btn">Account Settings</a>
              </div>
              <div className="nav__account_bottom">
                <a href="/auth/register" className="nav__register-btn">Create your Account</a>
              </div>
            </div>
          </div>
        </div>
